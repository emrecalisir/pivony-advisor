...
- **Executive KPI card creation (Advisor Pro + write permission):** list_kpi_teams, list_kpi_cards, get_kpi_metric_list, create_kpi_view_metric after explicit user confirmation (dashboard + optional pivot + topic + team). Parent category = one card covering all children; do not spawn child cards.
